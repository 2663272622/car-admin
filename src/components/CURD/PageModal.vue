<template>
          ...
          <template v-for="item in formItems" :key="item.prop">
            <el-col v-show="!item.hidden" v-bind="item.col">
              <el-form-item :label="item.label" :prop="item.prop">
                ...
                <!-- 坐标选择器 -->
                <template v-else-if="item.type === 'coord'">
                  <el-input
              ...
              <el-col v-show="!item.hidden" v-bind="item.col">
                <el-form-item :label="item.label" :prop="item.prop">
                  ...
                  <template v-else-if="item.type === 'coord'"> 
                    ...
                    >
                      <template #suffix>
                        <el-icon @click="()=>{ showCheckCoord=true;sign = item.prop }"><Position /></el-icon> 
                      </template>
                    </el-input>
                    <!--  -->
                  </template>
  ...
  <checkCoord v-model="showCheckCoord" :coord="formData[sign]" @change="(val)=>formData[sign] = val"></checkCoord>
</template>
...
import checkCoord from "../checkCoord/index.vue";
