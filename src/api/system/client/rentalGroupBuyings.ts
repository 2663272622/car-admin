...
const rentalGroupBuyings_BASE_URL = "/api/v1/rentalGroupBuyings";
...
const rentalGroupBuyingsAPI = {  
  ...
  setMatching(id) {
    // return request<any, PageResult<SchoolWallItem[]>>({
      return request({
      url: `${rentalGroupBuyings_BASE_URL}/updateRentalGroupBuyingStatus/${id}`,
      method: "put", 
    });
  },
  // /api/v1/rentalGroupBuyings/updateRentalGroupBuyingStatus/{id}
  /**
   * 小程序用户表单数据
   *
   * @param id NoticeID
