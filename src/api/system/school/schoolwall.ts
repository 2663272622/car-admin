...
const SchoolWall_BASE_URL = "/api/v1/isForums";
...
const SchoolWallAPI = {  
  ...
  getFormData(id: number) {
    return request<any, any>({
      url: `${SchoolWall_BASE_URL}/${id}/form`,
      method: "get",
    });
  },
