...
const riderAudit_BASE_URL = "/api/v1/isApplications";
...
const riderAuditAPI = {  
  ...
  getFormData(id: number) {
    return request<any, any>({
      url: `${riderAudit_BASE_URL}/${id}/form`,
      method: "get",
    });
  },
