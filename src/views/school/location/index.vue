  ...
  <div class="app-container">
    ...
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column prop="tenantName" label="学校名称" min-width="150" />
        <el-table-column prop="address" label="楼宇" min-width="150" />
...
import schoolLocationAPI,{QueryParams} from "@/api/system/school/schoolLocation";
import {formatApplyDate}  from '@/utils/datedisplay';
import themeEdit from '@/views/school/location/edit.vue'
...
function handleQuery() {
  ...
  schoolLocationAPI.getPage(params).then((data:any) => {
...
function handleDelete(id?: number) {
  ...
  ElMessageBox.confirm("确认删除已选中的数据项?", "警告", {
    ...
    () => {
      loading.value = true;
      schoolLocationAPI.deleteByIds(ids)
        .then(() => {
