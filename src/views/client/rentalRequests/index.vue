...
import themeEdit from '@/views/client/rentalRequests/edit.vue'
...
function handleQuery() {
  ...
  console.log(params)
  rentalRequestsAPI.getPage(params).then((data:any) => {
    // debugger
...
function handleGroup(id?: number) {
  ElMessageBox.confirm("确认设置为已组团吗?", "提示", {
...
function handleDelete(id?: number) {
  ...
  ElMessageBox.confirm("确认删除已选中的数据项?", "警告", {
    ...
    () => {
      loading.value = true;
      rentalRequestsAPI.deleteByIds(ids)
        .then(() => {
