  ...
  <div class="app-container">
    ...
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column prop="code" label="学校编号" width="200" />
    ...
    >
      <el-form ref="deptFormRef" :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学校编号" prop="code">
          <el-input v-model="formData.code" placeholder="请输入学校编号" />
        </el-form-item>
...
const rules = reactive({
  parentId: [{ required: true, message: "上级学校不能为空", trigger: "change" }],
  name: [{ required: true, message: "学校名称不能为空", trigger: "blur" }],
  code: [{ required: true, message: "学校编号不能为空", trigger: "blur" }],
